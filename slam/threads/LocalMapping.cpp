...
void LocalMapping::InitializeIMU(float priorG, float priorA, bool bFIBA)
{
    ...
    //     nMinKF = 10;
    // }
    float minTime = mbMonocular ? 2.0f : 1.0f;
    int   nMinKF  = 10;
    ...
    // Before this line we are not changing the map
    {
        ...
        // if scale is not nearly equal to 1 or not monocular
    ...
    if (!mpAtlas->isImuInitialized())
    {
        ...
        std::cout << "[Imu init Rwg]\n" << mRwg << std::endl;
        std::cout << "[Current Key Frame after imu init]\n"
                  << mpCurrentKeyFrame->GetPose().matrix() << std::endl;
    }
...
double LocalMapping::GetCurrKFTime()
{
    ...
    //     return 0.0;
    // }
    return mpCurrentKeyFrame ? mpCurrentKeyFrame->mTimeStamp : 0.0;
}
