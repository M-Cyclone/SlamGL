    ...
    // image info
    {
        ...
        if (desc.imageInfo.newHeight.has_value())
        {
            ...
            if (!bNeedToRectify_)
            {
                ...
                calibration1_->setParameter(
                    calibration1_->getParameter(1) * scaleRowFactor,
                    1);
                calibration1_->setParameter(
                    calibration1_->getParameter(3) * scaleRowFactor,
                    3);
        ...
        if (desc.imageInfo.newWidth.has_value())
        {
            ...
            if (!bNeedToRectify_)
            {
                ...
                calibration1_->setParameter(
                    calibration1_->getParameter(0) * scaleColFactor,
                    0);
                calibration1_->setParameter(
                    calibration1_->getParameter(2) * scaleColFactor,
                    2);
...
void Settings::readImageInfo(cv::FileStorage& fSettings)
{
        ...
        if (!bNeedToRectify_)
        {
                ...
                cameraType_ != Rectified)
            {
                calibration2_->setParameter(
                    calibration2_->getParameter(1) * scaleRowFactor,
                    1);
                calibration2_->setParameter(
                    calibration2_->getParameter(3) * scaleRowFactor,
                    3);
            }
        }
    }
    ...
    if (found)
    {
        ...
        if (!bNeedToRectify_)
        {
            ...
            {
                calibration2_->setParameter(
                    calibration2_->getParameter(0) * scaleColFactor,
                    0);
                calibration2_->setParameter(
                    calibration2_->getParameter(2) * scaleColFactor,
                    2);
